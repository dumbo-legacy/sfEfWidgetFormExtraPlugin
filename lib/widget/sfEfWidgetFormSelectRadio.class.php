<?php
/**
 * sfEfWidgetFormSelectRadio represents an array of radios
 *
 ...
 * @version    SVN: $Id$
 */
class sfEfWidgetFormSelectRadio extends sfWidgetForm
{
  /**
   * Constructor.
   *
...
<script type="text/javascript">
  jQuery(document).ready(function() {
    jQuery("ul.%s input:radio").checkbox(jQuery.extend({}, {
